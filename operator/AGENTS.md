...
The static content of `helm/cubestack-operator/` (`templates/`, `crds/`, `vap.yaml`) is generated by `hack/update-helm-resources.sh` from the `config/` sources. Only `Chart.yaml`, `values.yaml`, `.helmignore` and READMEs are hand-written.
